...
def test_process_sources(
    ...
    non_merged_fingerprints = 2 * [1, 2, 2]
    # ocp and ansible fingerprints wont be part of deduplication/merging process
    assert fingerprints == [1, 2] + non_merged_fingerprints
